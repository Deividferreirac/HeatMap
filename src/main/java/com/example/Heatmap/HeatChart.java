...
public class HeatChart {
    ...
    public HeatChart(double[][] zValues, double low, double high) {
        ...
        this.cellSize = new Dimension(65, 70);
        this.margin = 25;
        ...
        this.highValueColour = Color.WHITE;
        this.lowValueColour = Color.BLUE;
    ...
    /**
     * Returns the y-values which are currently set to display along the y-axis.4
     * The array that is returned is either that which was explicitly set with
     ...
     */
    public Color getAxisLabelColour(Color blue) {
